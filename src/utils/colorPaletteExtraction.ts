const buildPalette = colorsList => {
	...
	let finalComplementaryColors: string[] = [];
	...
	for (let i = 0; i < orderedByColor.length; i++) {
		...
		if (hslColors[i].h) {
			...
			finalComplementaryColors = [...finalComplementaryColors, ''];
		}
	}
	return [finalColors, finalComplementaryColors];
};
...
export function extractColors(imgId: string) {
